        ...
        <section class="">
            ...
            <div class="row">
                ...
                <div class="col-md-4 px-lg-4 my-4 my-md-2">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item bg-transparent text-light px-0"><i class="fa fa-home me-2"></i>3103,
                            Sylhet, Bangladesh
                        </li>
                        <li class="list-group-item bg-transparent text-light px-0"><i class="fa fa-envelope me-2"></i><a
                                class="text-light" href="mailto:mrmamun20162017@gmail.com">mrmamun20162017@gmail.com</a>
                        </li>
                        <li class="list-group-item bg-transparent text-light px-0"><i class="fa fa-phone me-2"></i><a
                                class="text-light" href="tel:+8801765700825">+880 1765 700 825</a>
                        </li>
                    </ul>
                </div>
